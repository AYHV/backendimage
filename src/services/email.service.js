...
const sendPhotoDeliveryEmail = async (email, deliveryDetails) => {
    ...
    <ul>
      ...
      <li><strong>Access Link:</strong> <a href="${deliveryDetails.accessLink}">View Photos</a></li>
      ${deliveryDetails.expiresAt ? `<li><strong>Expires:</strong> ${deliveryDetails.expiresAt}</li>` : ''}
    </ul>
...
const sendBookingCancellationEmail = async (email, cancellationDetails) => {
    ...
    <ul>
      ...
      ${cancellationDetails.refundAmount ? `<li><strong>Refund Amount:</strong> $${cancellationDetails.refundAmount}</li>` : ''}
    </ul>
